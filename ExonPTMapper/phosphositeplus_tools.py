...
### to generate phosphositeplus data file to use with ExonPTMapper, run the 'convert_pSiteDataFiles' function  ###
##################################################################################################################
...
def convert_pSiteDataFiles(phosphositeplus_data_dir, out_file_name = 'phosphositeplus_data.csv'):
    """
